...
<%
    ...
    for (int i = 0; i < auteurs.size(); i++) {
        ...
        out.print("<button style=\"background-color: #4CAF50; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;\" type=\"submit\" name=\"matricule\" value=\"" + auteurs.get(i).getMatricule() + "\">Modifier</button>");
        out.print("</form>");
        out.print("</td>");

        out.print("<td>");
        out.print("<form action=\"delete-auteur-servlet\" method=\"post\">");
        out.print("<button style=\"background-color: #f44336; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;\" type=\"submit\" name=\"matricule\" value=\"" + auteurs.get(i).getMatricule() + "\">Supprimer</button>");
        out.print("</form>");
        out.print("</td>");
