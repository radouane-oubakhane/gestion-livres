...
<form action="add-auteur-servlet" method="post">
    <input type="hidden" name="matricule" value="<%=((Auteur) request.getAttribute("auteur")).getMatricule()%>">
    <label for="title">Nom:</label>
    <input type="text" id="title" name="nom" required
    value="<%=((Auteur) request.getAttribute("auteur")).getNom()%>"
    ><br>

    <label for="title">Prenom:</label>
    <input type="text" id="title" name="prenom" required
    value="<%=((Auteur) request.getAttribute("auteur")).getPrenom()%>"
    ><br>
